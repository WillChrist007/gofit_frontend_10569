        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card border-0 rounded shadow">
                    ...
                    <router-link :to="{ name: 'kasir.transaksidepositkelas.index' }" class="btn btn-warning mt-0 m-3">
                        Kembali
                    </router-link>
                </div>
            </div>
    ...
    export default {
        setup() {
            ...
            onMounted(() => {
                ...
                axios
                    .get("https://200710569.gofit.backend.given.website/api/transaksiDepositKelas/" + id, )
                    .then(response => {
