    ...
    export default {
        setup() {
            ...
            onMounted(() => {
                ...
                axios.get('http://127.0.0.1:8000/api/jadwalHarian')
                    .then(response => {
            ...
            //method generate
            function generate() {
                axios.get(`http://127.0.0.1:8000/api/jadwalHarian/generate-jadwal`)
                    .then(() => {
            ...
            //method delete
            function remove() {
                axios.delete(`http://127.0.0.1:8000/api/jadwalHarian/`)
                    .then(() => {
                        window.location.reload();
