                ...
                <div class="card border-0 rounded shadow">
                    <div class="card-body" id="print-form">
                        <template v-for="(booking_kelas, id) in booking_kelass" :key="id">
                            ...
                            <template v-for="(member, id) in members" :key="id">
                                <p v-if="member.id === booking_kelas.id_member">Sisa Deposit : Rp{{ member.deposit_uang }}</p>
                            </template>
                        </template>
                    </div>
    ...
    export default {
        setup() {
            ...
            onMounted(() => {
                ...
                axios.get('http://127.0.0.1:8000/api/bookingKelas/'+ id,)
                    .then(response => {
            ...
            function printForm() {
                ...
                const options = {
                margin: 10,
                filename: 'presensi_kelas_reguler.pdf',
